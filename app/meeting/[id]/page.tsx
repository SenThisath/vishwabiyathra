...
const Meeting = ({
  ...
  const handleJoinMeeting = async () => {
    ...
    if (cameraReady && microphoneReady && screenShareReady) {
      ...
      alert("Please ensure camera, microphone and screen sharing are enabled before joining");
    }
  };
      ...
      <div className="p-4 flex flex-col gap-4 items-center justify-center">
        ...
        <div className="flex flex-col gap-2 w-full max-w-md">
          <div className="flex justify-between items-center">
            <span>Camera:</span>
            <span className={deviceStatus.camera ? "text-green-500" : "text-red-500"}>
          ...
          <div className="flex justify-between items-center">
            ...
            <span className={deviceStatus.microphone ? "text-green-500" : "text-red-500"}>
          ...
          <div className="flex justify-between items-center">
            ...
            <span className={deviceStatus.screenShare ? "text-green-500" : "text-red-500"}>
        ...
        <Button 
          ...
          disabled={!deviceStatus.camera || !deviceStatus.microphone || !deviceStatus.screenShare}
          className="mt-4"
        >
          Join Meeting
        </Button>
